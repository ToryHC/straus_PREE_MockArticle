...
invert.density.destfile <- "/Users/sam/LDP/PROD_REPRO/sam-s-practice-assignment-sdstraus/data/TLW_density.csv"
...
invert.metadata.destfile <- "/Users/sam/LDP/PROD_REPRO/sam-s-practice-assignment-sdstraus/data/TLW_metadata.csv"
download.file(invert.metadata.url, invert.metadata.destfile, method = "curl", extra = "-k")

dat <- read.csv("../data/TLW_density.csv")
